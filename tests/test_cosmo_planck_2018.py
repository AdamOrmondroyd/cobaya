...
def test_planck_2018_t_CamSpec_native_camb(
    packages_path, skip_not_installed, plik=False
):
...
def test_planck_2018_t_CamSpec_clik_camb(packages_path, skip_not_installed):
    test_planck_2018_t_CamSpec_native_camb(
        packages_path, plik=True, skip_not_installed=skip_not_installed
    )


def test_planck_2018_p_CamSpec_native_camb(
    packages_path, skip_not_installed, plik=False
):
    # TODO: sort out calPlacnk vs A_planck
    name = (
...
def test_planck_2018_p_CamSpec_clik_camb(packages_path, skip_not_installed):
    test_planck_2018_p_CamSpec_native_camb(
        packages_path, plik=True, skip_not_installed=skip_not_installed
    )
